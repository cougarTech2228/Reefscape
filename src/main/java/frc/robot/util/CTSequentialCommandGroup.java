 ...
 */
public class CTSequentialCommandGroup extends Command {
  ...
  public CTSequentialCommandGroup(Command... commands) {
  ...
  public final boolean isFinished() {
    // 2228 change to allow ended commands to report as "isFinished"
