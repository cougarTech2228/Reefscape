...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        Command algaeAndCoralCommand = new PrepPlaceCoralCommand(true, ReefSegment.Segment_2, ReefLocation.L3_R, elevator, algaeAcquirer, coralCone);
