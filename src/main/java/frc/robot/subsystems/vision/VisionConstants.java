...
public class VisionConstants {
    ...
    public static Transform3d robotToCamera1 = new Transform3d(
            0.3462, 0.2838, 0.2286, new Rotation3d(0.0, Math.toRadians(-45), Math.toRadians(-35)));
    public static Transform3d robotToCamera2 = new Transform3d(
            0.3462, -0.2838, 0.2159, new Rotation3d(0.0, Math.toRadians(-20), Math.toRadians(35)));
    public static Transform3d robotToCamera3 = new Transform3d(
            -0.1838, -0.2838, 0.2286,
            new Rotation3d(0.0, Math.toRadians(-55), Math.toRadians(-(35 + 180))));
    public static Transform3d robotToCamera4 = new Transform3d(
            -0.2138, 0.2838, 0.2159, new Rotation3d(0.0, Math.toRadians(-23), Math.toRadians(35 + 180)));
