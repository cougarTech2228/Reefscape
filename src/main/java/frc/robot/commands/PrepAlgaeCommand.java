...
public class PrepAlgaeCommand extends Command{
    ...
    public PrepAlgaeCommand(AlgaeHeight height, Elevator elevator, AlgaeAcquirer algaeAcquirer, CoralCone coralCone) {
        this.height = height;
    ...
    public void initialize() {
        System.out.println("Starting PrepAlgaeCommand height: " + height);
        switch (height){
            case Floor:
