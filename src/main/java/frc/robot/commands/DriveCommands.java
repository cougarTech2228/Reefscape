...
public class DriveCommands {
  ...
  public static Command shortAutoPath(Drive drive) {
    // Create a list of waypoints from poses. Each pose represents one waypoint.
    Pose2d currentPose = drive.getPose();
    // going to close side of blue reef, rotate first then translate
    List<Waypoint> waypoints = PathPlannerPath.waypointsFromPoses(
        new Pose2d(currentPose.getX(), currentPose.getY(), Rotation2d.fromDegrees(0)),
        new Pose2d(2.75, 4.4, Rotation2d.fromDegrees(0)));
