...
public enum Destination {
    BLUE_1_LEFT (3.0,4.4,0,0,7,0,1,2.5,3,2.5,5);
    //BLUE_1_RIGHT (3.0,4.0,0),
    //BLUE_2_LEFT (3.25,2.9,60);
    ...
    private Destination(double x, double y, double angle, double p1x, double p1y, double p2x, double p2y, double p3x, double p3y, double p4x, double p4y) {
    ...
    public Rotation2d getAngle() {return pose.getRotation();}
